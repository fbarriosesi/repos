Public Class frmOperarioPuerto
    ...
    Private Sub frmOperarioPuerto_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        txtLote.Text = "Sin Lote"
    ...
    Private Sub cmdInspeccion_Click(sender As Object, e As EventArgs) Handles cmdInspeccion.Click
        ...
        l.InsertLote(txtLote.Text, txtid_vehiculo.Text)
        frmInspeccion.Show()
    ...
    Private Sub cmdBuscar_Click(sender As Object, e As EventArgs) Handles cmdBuscar.Click
        ...
        cmdInspeccion.Enabled = True

        c.vin = txt_Vin.Text
        txt_Vin.Text = c.vin

        Select Case c.buscarVehiculo2(cn)
            Case 0 'SE BUSCO Y SE ENCONTRO
                ...
                txtLote.Text = l.AsignarLote(c.id_vehiculo)
    ...
    Private Sub frmOperarioPuerto_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
